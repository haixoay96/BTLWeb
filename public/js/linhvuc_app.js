/**
 * Created by thanh huyền on 11-Dec-16.
 */
// (function () {
//     'use strict';
//     angular.module('linhvuc_tree',['ui.router'])
//         .controller('linhvucCtrl', [$scope, function ($scope) {
//             $scope.roleList1 = [
